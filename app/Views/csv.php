...
<html>
  ...
  <body>
    ...
    <form method="post" action="<?php echo base_url('user_reports_csv/download'); ?>">
    <!DOCTYPE html>
<html>
  <head>
    <title>Timesheet Report</title>
  ...
  <body>
    ...
    <form method="post" action="<?php echo base_url('user_reports/download_csv'); ?>">
...
if ($download == 1 )
 {
  ...
  {
    ?>
    <button type="submit" class="btn btn-success float-right">Download CSV</button>
    <?php
}
?>
<div>
