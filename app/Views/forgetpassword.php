...
input.error {
  ...
  <div class="global-container">
    ...
    <h4>Please entry your email address you'd like your password reset information sent to</h4>
		<div class="card-text">
    <?php if(session()->getFlashdata('msg')):?>
			...
			<form method="post"   id="login-form" action="<?php echo base_url(); ?>recoverpassword">
          ...
          <input type="hidden" class="hide" name="token" id="token" value=""> 
				...
				<div class="sign-up">
				<p>Return back to login<a href="<?php echo base_url(); ?>login">click here</a></p>
				</div>
			</form>
		</div>
	</div>
